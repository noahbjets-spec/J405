...
Private colleges administer students with higher SATs score on average as opposed to public colleges. There is a 75 point gap between the two mean scores. Two year universities scored much worse on average, scoring 292 points worse then public school students and 367 points   worse then private school students. Community college students had a more spread out standard devation then private schools 
...
There is a significant difference as the F level passes all threshold of significant.  
2. Which specific college types differ from each other?
Private schools differ from public schools as the p value is 2.1e-05 which suggest high  which suggest the results are highly signifcant in thier variance. 
3. How large are these differences?
The difference  between private and public schools is around -74 while the difference between private school and public schools is around 366.
...
"New study finds private college students score significant high then those in community college"

Private colleges admit students with far higher SAT scores than public or community colleges, according to new data. An analysis using ANOVA indicated significant differences among the three groups. Private school students usually average around 1,450 which is 75 abover the average public school student and 350 points about community college attendees
