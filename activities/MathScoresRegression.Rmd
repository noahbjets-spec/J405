...
There is a weak positive correlation displayed on the graph. I belive that their is no real signfincacnce however given how weak the realationship seems  
...
The model isn't reliable as the p-value shows their really isn't much significant but the model alone suggests otherwise.  nj
...
The member is wrong as the results are not significant despite what the model looks like. The p value of 0.1225 indicates that there is no realtationship between the two factors. 
