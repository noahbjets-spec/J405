...
Waiting can make up for underrepresented groups in a survery meaning Weighting adjusts the results so they better reflect the true population.
2. Which demographic groups show the largest differences between weighted and unweighted results?  Education, race/ethnicity, age, and region are typically where the biggest gaps occur.
3. How might weighting influence reporting of this data?
Weighting can  shift the narrative. An unweighted survey might make it disproportionate to what data actually is showing 
...
1. What is the range of weights in this dataset? The weights range from 0.23 to 3.04, this means the smallest weight is 0.23 and the largest is 3.04.
2. What does it mean when a respondent has a weight of 0.23? What about 3.04? 
A weight of 0.23 means that a person's demographic group was overrepresented. 

3. Why might some respondents be weighted more heavily than others? **Write Because some types of people are less likely to take surveys like  low income individuals, or  minorities.
...
1. Which voter category shows the biggest difference between weighted and unweighted results? The rare/never category. The “Yes” responses dropped by about 3.6 percentage points where is much larger then the others

2. How might these differences affect reporting on likely voter turnout? Without weighting, it might look like more people who rarely vote plan to vote this year. Weighting fixes that

3. Why do you think these differences exist? What does this tell us about who might be over or under-represented in the sample? Those who do not vote often but still take surveys are likely more interested in politics than nonvoters. That means they show up more in the survey than in real life, so they’re overrepresented.
