...
The majority of survey takers, likely take politics very seriously and this often aligns with those who have a higher education. Individuals with a lower level of education might not have access to survey centers as they are usually done at Universities.
...
"Those with higher education, more likely to vote, new survey finds"
...
The 'College' and 'some college' categorizes remains consistant but 'High school or less' saw a three percent decline in the number of 'yes' and a two percent increase in 'no'. This shows that some people with less education were missed in the first results. Weighting makes sure their answers count more, so the numbers match what the country really looks like.

2. Why might the weighted results be considered more accurate than the unweighted results?

Weighted results account for underrepresented groups like the 'High school or less' category. They make up for misrepresentation due to popular samples. 
...
The 'High school or less' group shows the largest difference between weighted and unweighted results in both categories. This makes sense because people with less education don’t take as many surveys. The answers balance out. 
...
1. Why is it important for journalists to understand survey weighting when reporting on polls?
 ...
 Journalists need to understand how survey weight is distributed because it puts the data into perspective. journalists need all the information they can get to appropriately write a story with stats, and knowing whether data is weighted or not can directly effect the outcome of the story

2. How might the differences between weighted and unweighted results affect how you would report on this data?

     The 'High School or less category would be misrepresented if one just looks at the unweighted data, whereas weighted data paints a more accurate picture. The differences between weighted and unweighted numbers show that I must explain to readers must how the poll was done to be transprent. 
...
I would want to know if they used any other variables for weighting. Was it just education, or did they also include age or race others? This is vital information if I am going to print an accurate story.
