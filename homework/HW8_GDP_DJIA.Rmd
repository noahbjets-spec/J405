...
```{r}
correlation <- cor(gdpdata$GDP, gdpdata$DJIA)
...
gdpdata |> 
  ...
  labs(
    title = " U.S. GDP and DJIA Correlation",
    x = "GDP Change", y = "DJIA Change")
...
The scatterplot shows an extremely strong correlation between the DJIA and GDP. As the DJIA rises so does the GDP. This is reflected through the stable .953 coefficient found earlier in the code. 
