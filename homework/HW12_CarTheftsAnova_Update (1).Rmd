...
ggplot(theft_data, aes(x = date, y = theft_rate)) +
  ...
  labs(title = "Car thefts jumped in 2022 but have gradually declined, Data Shows",
...
The chart shows moderate to low rates of car theft untill 2022 when rates soared. The trend peaked in early 2023 and is now starting to settle again.

Car thefts jumped in 2022 but have gradually declined, Data Shows
...
- **Null Hypothesis (H0)**: 2023 significantly stood out from other years
- **Alternative Hypothesis (H1)**: There is nothing significant about 2023
...
It seems that car theft rates didn’t just spike by chance. Instead they changed dramatically across different time periods, specifically 2023. The F value of 218 is extremely high, while the the p-value is below all thresholds.
...
The Tukey test shows a clear, significant difference between each time period. Before the spike period, there were approximately 25 thefts per 100K people; in 2023, this number jumped to around 60. In the post-spike period, it dropped but stayed around 45, according to the chart. The confidence intervals don’t overlap, so the difference is real and significant.

"Car thefts starting to stabilize after spike year."
Car theft rates soared in late 2022 but are starting to decline. Rates still remain higher than before the hike, and tests showed a significant change between the periods before, during, and after the trend.